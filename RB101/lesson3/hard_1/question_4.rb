...
# You're not returning a false condition, and you're not handling the case that there are more
...
# component, he used break to break out of the while loop. Once he breaks, control falls through to 
# the return true statement. He can fix this by performing return false instead of break.
