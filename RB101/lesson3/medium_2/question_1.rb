...
#    The "under the hood" object referred to by a particular named-variable can change depending
...
#inside or outside of the loop, the scope for the object ids doesn't matter, after the variables
