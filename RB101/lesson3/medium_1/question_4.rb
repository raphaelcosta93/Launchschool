...
# Yes in the first method with the shovel operator "<<" the original argument will be mutated 
# and changed after the the method is executed

# In the second method with the operator '+' the original argument wont be mutated or changed
